...
class BreastCancerPredictor:
    def __init__(self, model_path='models/breast_cancer.pkl'):
        ...
        try:
            ...
            if shap_rows:
                explanation = {
                    ...
                    "features": shap_rows,
                    "description": (
                        "Each bar shows how much a lab value pushed the prediction toward "
                        "Malignant (positive) or Benign (negative)."
                    ),
                }
